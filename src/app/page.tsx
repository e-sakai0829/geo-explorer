...
export default function LandingPage() {
  return (
    <div className="-m-8 bg-white min-h-screen text-slate-900 selection:bg-blue-600 selection:text-white">
      {/* Navigation Header */}
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div className="font-bold text-base tracking-tight text-slate-900">
              GEO Explorer
              <span className="ml-2 text-[10px] bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full font-mono border border-blue-200">
                PRO
              </span>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-slate-600">
            <a href="#features" className="hover:text-blue-600 transition-colors">機能と特徴</a>
            <a href="#comparison" className="hover:text-blue-600 transition-colors">他社ツール比較</a>
            <a href="#pricing" className="hover:text-blue-600 transition-colors">料金プラン</a>
            <Link href="/insights" className="hover:text-blue-600 transition-colors">公式コラム</Link>
          </nav>

          <div className="flex items-center gap-3">
            <Link
              href="/dashboard"
              className="text-xs font-bold text-slate-700 hover:text-slate-900 px-3 py-2 rounded-lg hover:bg-slate-50 transition-colors"
            >
              ログイン
            </Link>
            <Link
              href="/prompts"
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow-md shadow-blue-500/20 transition-all"
            >
              無料診断を試す
      ...
      <section className="pt-20 pb-24 px-6 max-w-5xl mx-auto text-center space-y-6">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-50 text-blue-700 rounded-full text-xs font-bold border border-blue-200/60 shadow-xs">
          <Sparkles className="w-3.5 h-3.5" />
          Google AI Overviews ＆ Gemini 完全対応のGEO SaaS
        </div>
        ...
        <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
          ...
          AI内部展開クエリ（Fan-out）を網羅した「35〜65文字直答記事」を自動生成する国内初のGEOプラットフォーム。
        </p>

        {/* Free Trial Form Bar */}
        <div className="max-w-xl mx-auto pt-4">
          <form action="/prompts" className="flex items-center bg-slate-50 p-1.5 rounded-2xl border border-slate-200 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:bg-white transition-all">
            ...
            <input
              ...
              className="flex-1 bg-transparent px-3 py-2.5 text-xs text-slate-900 focus:outline-hidden"
            />
            <button
              type="submit"
          ...
          <div className="flex items-center justify-center gap-4 text-[11px] text-slate-400 mt-2.5">
            <span className="flex items-center gap-1"><Check className="w-3 h-3 text-emerald-500" /> クレジットカード不要</span>
            <span>•</span>
            <span className="flex items-center gap-1"><Check className="w-3 h-3 text-emerald-500" /> 1秒でリアルタイム解析</span>
          </div>
        </div>
      </section>

      {/* Why GEO? Section (課題提起) */}
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold text-blue-600 uppercase tracking-wider">Market Shift</span>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 tracking-tight">
              従来のSEOだけでは、なぜアクセスが消滅するのか？
            </h2>
            <p className="text-xs text-slate-500">
              検索体験は「リンク一覧」から「AIの直答要約」へ完全に移行しました。
            </p>
          </div>
      ...
      <section id="features" className="py-24 max-w-6xl mx-auto px-6 space-y-16">
        ...
        <div className="space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-xl space-y-3 font-mono text-xs">
              ...
              <div className="bg-blue-600/30 p-3 rounded-lg border border-blue-500/40 text-blue-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-white border-2 border-blue-600/30 rounded-2xl p-6 shadow-lg space-y-3 text-xs">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-slate-800 leading-relaxed">
                ...
                <span className="text-blue-700 font-bold">「月額1人あたり1,500円〜3,500円が相場であり、従来のオンライン英会話の約1/3の費用で導入可能です。」</span>
      ...
      <section id="comparison" className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="max-w-5xl mx-auto px-6 space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold text-blue-600 uppercase tracking-wider">Comparison</span>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 tracking-tight">
              他社ツールとの決定的な違い
            </h2>
            <p className="text-xs text-slate-500">
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-slate-100/70 border-b border-slate-200 text-slate-600 font-bold">
                <tr>
                  ...
                  <th className="py-4 px-6 bg-blue-50/50 text-blue-900 font-black border-x border-blue-200">
                    ★ GEO Explorer（当社）
                  </th>
                  <th className="py-4 px-6">大手ミエルカGEO</th>
                  <th className="py-4 px-6">従来のSEOツール (Ahrefs等)</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 text-slate-700">
                <tr>
                  <td className="py-4 px-6 font-bold">月額料金</td>
                  <td className="py-4 px-6 bg-blue-50/30 font-black text-blue-600 border-x border-blue-100 text-sm">
                    ¥9,800〜
                  </td>
                  <td className="py-4 px-6">¥100,000〜（+初期10万）</td>
                  <td className="py-4 px-6">¥20,000〜 ($129/mo)</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-bold">AI検索（AIO/Gemini）言及可視化</td>
                  <td className="py-4 px-6 bg-blue-50/30 font-bold text-emerald-600 border-x border-blue-100">◯ 完全対応</td>
                  <td className="py-4 px-6 text-emerald-600 font-bold">◯ 対応</td>
                  <td className="py-4 px-6 text-slate-400">× 非対応</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-bold">クエリファンアウト抽出</td>
                  <td className="py-4 px-6 bg-blue-50/30 font-bold text-emerald-600 border-x border-blue-100">◯ 全自動</td>
                  <td className="py-4 px-6">△ 一部対応</td>
                  <td className="py-4 px-6 text-slate-400">× 非対応</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-bold">35〜65文字直答記事の自動生成</td>
                  <td className="py-4 px-6 bg-blue-50/30 font-bold text-emerald-600 border-x border-blue-100">◯ 1クリック自動生成</td>
                  <td className="py-4 px-6 text-slate-400">× 通常のブログ生成のみ</td>
                  <td className="py-4 px-6 text-slate-400">× 非対応</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-bold">契約期間の縛り</td>
                  <td className="py-4 px-6 bg-blue-50/30 font-bold text-slate-900 border-x border-blue-100">なし（いつでも解約可）</td>
                  <td className="py-4 px-6 text-rose-600">6ヶ月〜1年契約</td>
                  <td className="py-4 px-6">月単位</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      {/* Pricing CTA Section */}
      <section id="pricing" className="py-24 max-w-5xl mx-auto px-6 text-center space-y-10">
        <div className="space-y-2">
          <span className="text-xs font-bold text-blue-600 uppercase tracking-wider">Pricing</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-xs flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 my-3">¥9,800 <span className="text-xs font-normal text-slate-400">/月</span></div>
          ...
          <div className="bg-white p-7 rounded-2xl border-2 border-blue-600 shadow-lg relative -translate-y-1 flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 my-3">¥29,800 <span className="text-xs font-normal text-slate-400">/月</span></div>
            ...
            <Link href="/pricing" className="mt-6 w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl text-center shadow-md shadow-blue-500/20 transition-all">
              Growth を申し込む
            </Link>
          </div>
          ...
          <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-xs flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 my-3">¥79,800 <span className="text-xs font-normal text-slate-400">/月</span></div>
